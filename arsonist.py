# -*- coding UTF-8 -*-
# КОММАНДА: Я волк одиночка(
# НОВОСТИ: https://t.me/+bcHl7TpfUopjYTMy
# АВТОР: ARSEN
...
try:
    ...
    print(f'\n{COLOR_CODE["RED"]}{COLOR_CODE["BOLD"]}[!] {COLOR_CODE["DARK"]}ПРОБЛЕМКА,РЕШАЮ!{COLOR_CODE["RESET"]}')
    ...
    print(f'{COLOR_CODE["RED"]}[+] {COLOR_CODE["YELLOW"]}Оригинально программное обеспечение находиться на: '+
         ...
         f'Мы в телеграмме: {COLOR_CODE["CYAN"]}{https://t.me/+bcHl7TpfUopjYTMy["SOFT_ORIGINAL_CHANNEL"]}{COLOR_CODE["RESET"]}')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print(f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[1] {COLOR_CODE["LI_G"]}'
            f'чек по  {COLOR_CODE["RED"]}Номерку{COLOR_CODE["LI_G"]} телефона.{COLOR_CODE["RESET"]}\n'
            
            f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[2] {COLOR_CODE["LI_G"]}'
            f'чекнуть {COLOR_CODE["RED"]}MNP{COLOR_CODE["LI_G"]} телефона.{COLOR_CODE["RESET"]}\n'
            
            f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[3] {COLOR_CODE["LI_G"]}'
            f'чек по {COLOR_CODE["RED"]}IP{COLOR_CODE["LI_G"]} телефона.{COLOR_CODE["RESET"]}\n'

            f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[4] {COLOR_CODE["LI_G"]}'
            f'Проверить {COLOR_CODE["RED"]}Гос. номерочек{COLOR_CODE["LI_G"]} автомобиля.{COLOR_CODE["RESET"]}\n'
            
            f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[5] {COLOR_CODE["LI_G"]}'
            f'Провести тех проверку {COLOR_CODE["RED"]}на работоспосбность сервиса.{COLOR_CODE["LI_G"]}{COLOR_CODE["RESET"]}\n')
